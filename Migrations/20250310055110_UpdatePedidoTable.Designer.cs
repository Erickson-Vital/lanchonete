...
namespace lanchonete.Migrations
{
    ...
    [Migration("20250310055110_UpdatePedidoTable")]
    partial class UpdatePedidoTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("lanchonete.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("lanchonete.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("lanchonete.Models.Pedido", b =>
                {
                    b.HasOne("lanchonete.Models.ApplicationUser", "Usuario")
                        .WithMany()
